  ...
  },
  {
    ...
    children: [
        ...
        children: [
          {
            name: 'sales',
            path: 'sales',
            component: () => import('../pages/admin/reports/sales-reports/SalesReports.vue'),
            // meta: {
            //   wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Tables',
            // },
          },
          {
            name: 'expenses',
            path: 'expenses',
            component: () => import('../pages/admin/reports/expense-reports/ExpenseReport.vue'),
            // meta: {
            //   wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Tables',
            // },
          },
      ...
      },
      {
        name: 'stocks',
        path: 'stocks',
        component: () => import('../pages/admin/stocks/Stocks.vue'),
      },
      {
        name: 'menus',
        path: 'menus',
    ...
    children: [
      {
        name: 'login',
        path: 'login',
        component: () => import('../pages/login/CustomLogin.vue'),
      },
      // {
      //   name: 'signup',
      //   path: 'signup',
